...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nakshikar's Studio crafts paintings, murals, sculptures, signages, branding and digital design for residential, commercial and luxury spaces." },
    ],
    links: [
